pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/CrystalStarshine/mccurdca-lb-deploy'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('mccurdca-225')   // <---- Change this to match your kubernetes cluster credentials
    }
